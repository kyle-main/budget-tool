...
const CATEGORIES: Category[] = [
  ...
  { value: 'Maintenance', parent: PARENT_CATEGORIES.HOME },
  ...
  { value: 'Gas', parent: PARENT_CATEGORIES.TRANSPORTATION },
  { value: 'Maintenance', parent: PARENT_CATEGORIES.TRANSPORTATION },
  { value: 'Uber', parent: PARENT_CATEGORIES.TRANSPORTATION },
  { value: 'Public Transport', parent: PARENT_CATEGORIES.TRANSPORTATION },
  ...
  { value: 'Veterinarian', parent: PARENT_CATEGORIES.DAILYLIVING },
  { value: 'Donations', parent: PARENT_CATEGORIES.DAILYLIVING },
  { value: 'Cat Food', parent: PARENT_CATEGORIES.DAILYLIVING },
